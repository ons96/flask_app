...
GOOGLE_TARGET_MODELS = {
    "Gemini 2.5 Flash",  # Keep in list but will only use if API key works
    "Gemini 2.0 Flash",
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=5001, debug=True) # ENABLED debug mode for better logging/reloading