...
(function () {
    'use strict';
    try {
        // alert('Roleplay JS loading...'); // Debug

        var models = {
            groq: ['llama-3.1-70b-versatile', 'llama-3.1-8b-instant', 'mixtral-8x7b-32768'],
            openrouter: ['moonshotai/moonshot-v1-8k', 'moonshotai/moonshot-v1-32k', 'meta-llama/llama-3.1-70b-instruct:free', 'meta-llama/llama-3.1-8b-instruct:free', 'google/gemma-2-9b-it:free'],
        ...
        function init() {
            // alert('Roleplay Init called'); // Debug
            try {
                if (providerSelect) updateModelDropdown();
                setupEventListeners();
                // alert('Roleplay Init complete'); // Debug
            } catch (e) {
                alert('Error in Roleplay Init: ' + e.message);
            }
        }
        ...
        alert('Critical Error in Roleplay JS: ' + err.message);
    }
})();
